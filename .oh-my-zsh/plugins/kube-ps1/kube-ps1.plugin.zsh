...
kube_ps1() {
  ...
  # Context
  if [[ "${KUBE_PS1_CONTEXT_ENABLE}" == true ]]; then
    KUBE_PS1+="$(_kube_ps1_color_fg $KUBE_PS1_CTX_COLOR)\033[1m${KUBE_PS1_CONTEXT}\033[0m${KUBE_PS1_RESET_COLOR}"
  fi
  ...
  if [[ "${KUBE_PS1_NS_ENABLE}" == true ]]; then
    ...
    KUBE_PS1+="$(_kube_ps1_color_fg ${KUBE_PS1_NS_COLOR})\033[1m${KUBE_PS1_NAMESPACE}\033[0m${KUBE_PS1_RESET_COLOR}"
  fi
